      ...
      <div *ngIf="showBankCards" class="flex flex-col gap-4 mt-4 items-center justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div class="atm-card relative shadow-lg bg-white text-black p-3 sm:p-4 rounded-lg">
            ...
            <div class="flex justify-between items-center tracking-widest mb-2 sm:mb-4">
              ...
              <button 
                (click)="copyToClipboard('185801003812507', 'rekening')"
          ...
          <div class="atm-card relative shadow-lg bg-white text-black p-3 sm:p-4 rounded-lg">
            <img src="https://shopeepay.co.id/src/pages/home/assets/images/new-homepage/new-spp-logo.svg" alt="ShopeePay Logo" class="absolute top-2 right-2 h-6 sm:top-4 sm:right-4 sm:h-8">
            <div class="chip bg-gold h-4 w-6 sm:h-6 sm:w-8 rounded-sm mb-2 sm:mb-4"></div>
            <p class="font-semibold text-sm sm:text-lg mt-2 mb-1 sm:mb-2">Alvyyatun Fauziah</p>
            <div class="flex justify-between items-center tracking-widest mb-2 sm:mb-4">
              <span class="font-mono text-xs sm:text-base">0852 6704 9273</span>
              <button 
                (click)="copyToClipboard('085267049273', 'rekening')"
                class="bg-white hover:bg-gray-300 font-bold text-orange-500 px-2 py-1 rounded text-xs sm:text-sm"
              >
                Copy
              </button>
            </div>
        ...
        <div class="max-w-xl bg-white bg-card-2 rounded-lg shadow-lg p-4 sm:p-6">
          <div class="flex items-center justify-center mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#58010F" class="w-6 h-6 mr-2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
              <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
            </svg>
            <h2 class="text-[#58010F] font-semibold text-lg">Alamat Pengiriman Hadiah</h2>
          </div>
          <div class="text-center text-[#58010F] text-sm sm:text-base relative">
            <p class="font-semibold mb-2">Alvyyatun Fauziah</p>
            <p class="leading-relaxed mb-4">
              Dusun Wonogiri, RT/RW. 012/003,<br>
              Desa Bumi Daya, Kec. Palas,<br>
              Kab. Lampung Selatan, Lampung<br>
              35593
            </p>
            <button 
              (click)="copyToClipboard('Alvyyatun Fauziah\nDusun Wonogiri, RT/RW. 012/003,\nDesa Bumi Daya, Kec. Palas,\nKab. Lampung Selatan, Lampung\n35593', 'alamat')"
              class="bg-[#58010F] text-white hover:bg-opacity-90 font-bold px-4 py-2 rounded-full text-sm sm:text-base flex items-center justify-center mx-auto"
            >
