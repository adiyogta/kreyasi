...
export class GuestManagementComponent implements OnInit, OnDestroy {
    ...
    private readonly SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx77ROXRPNgi3Jjui35fjMxkw5blzR5_Cj29BNXaMxgrlHHC4C6JgDcAMkBVbN8aofE_g/exec';
    ...
    generateLink() {
        ...
        this.guest.link = `https://jhonialvyyatun.kreyasi.my.id/${formattedName}`;
      }
    ngOnInit() {
      this.loadGuests();
